...
const CARDS: Card[] = [
  ...
  },
  {
    ...
    text: <>You can find me at <a href="https://maps.app.goo.gl/vY5gbPvwKufQewGg6" target="_blank" rel="noreferrer" style={linkStyle('#64B5F6')}>Broadway cinemas</a> almost every weekend. Tamil cinema, Hollywood, auteur films — if it's on the big screen, I'm there. Recent favourite — <a href="https://en.wikipedia.org/wiki/The_Odyssey_(2026_film)" target="_blank" rel="noreferrer" style={linkStyle('#64B5F6')}>The Odyssey</a>. Also a total sucker for Premium Large Formats — there's something about watching a film the way it was meant to be seen. Currently hunting PLF screens across India; have checked off IMAX with Laser, EPIQ, and HyperX so far. The list keeps growing.</>,
    tags: [
      { label: 'Broadway Cinemas', href: 'https://maps.app.goo.gl/vY5gbPvwKufQewGg6' },
      { label: 'The Odyssey', href: 'https://en.wikipedia.org/wiki/The_Odyssey_(2026_film)' },
      { label: 'EPIQ' },
      { label: 'HyperX' },
      { label: 'IMAX with Laser' },
    ],
    accent: '#64B5F6',
    link: {
