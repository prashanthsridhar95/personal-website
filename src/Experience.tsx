...
const ROLES = [
  {
    ...
    color: '#FF6B35',
    points: [
      'Built the Multi-Product KMP SDK — a config-driven engine powering Zoho\'s multi-product suite across mobile, macOS & Windows. Products onboard via JSON config without touching platform code.',
